    ...
    <div class="col-12">
      <div class="row">
        <div class="col-12 mt-5" style="text-align: center;">  
           <img class="card-image" style="width:40%;margin-top: 50px;background-color: white;border-radius: 50%;" alt="${pokemon.name}" src="https://assets.pokemon.com/assets/cms2/img/pokedex/full/003.png" />
           <p>Bulbassaur</p>
        </div>
        <div class="col-md-12 mt-5 mb-4" style="color: black;background-color: white;
  border-radius: 10px;
  padding: 20px;
